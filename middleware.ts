...
// Trzy ścieżki, bo tyle ma dziś apka. Lista jest jawna, a nie prefiksowa,
// żeby nowy ekran trzeba było tu dopisać świadomie.
const PROTECTED = ['/dashboard', '/expenses', '/settings']
...
export async function middleware(req: NextRequest) {
  ...
  // Podziału personal/business już nie ma — każdy zalogowany widzi te same
  // trzy ekrany, więc bramkowanie po `productType` zniknęło razem z nimi.
