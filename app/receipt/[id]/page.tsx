  ...
  if (!receipt) {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="w-full max-w-sm rounded-lg border border-border bg-card shadow-[var(--nb-shadow-sm)] p-8 text-center">
  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-8 px-4 print:bg-white print:py-0">
      <main className="mx-auto w-full max-w-md">
        ...
        {/* Receipt card */}
        <article className="rounded-lg border border-border bg-card shadow-[var(--nb-shadow-sm)] overflow-hidden print:shadow-none print:border-black">
          {/* HERO — vendor, date, big total */}
          <header className="px-6 pt-8 pb-7 text-center border-b border-dashed border-border">
          ...
          <section className="px-6 py-4 border-t border-dashed border-border bg-muted/20">
